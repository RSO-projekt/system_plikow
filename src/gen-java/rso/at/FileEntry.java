...
public class FileEntry implements org.apache.thrift.TBase<FileEntry, FileEntry._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(FileEntry other) {
    ...
    FileEntry typedOther = (FileEntry)other;
    ...
    lastComparison = Boolean.valueOf(isSetModificationTime()).compareTo(typedOther.isSetModificationTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetModificationTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.modificationTime, typedOther.modificationTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
