...
public class FileEntryExtended implements org.apache.thrift.TBase<FileEntryExtended, FileEntryExtended._Fields>, java.io.Serializable, Cloneable {
  ...
  public FileEntryExtended(FileEntryExtended other) {
    ...
    if (other.isSetMirrors()) {
      List<Integer> __this__mirrors = new ArrayList<Integer>();
      for (Integer other_element : other.mirrors) {
        __this__mirrors.add(other_element);
      }
  ...
  public int compareTo(FileEntryExtended other) {
    ...
    FileEntryExtended typedOther = (FileEntryExtended)other;
    ...
    lastComparison = Boolean.valueOf(isSetMirrors()).compareTo(typedOther.isSetMirrors());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMirrors()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mirrors, typedOther.mirrors);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
