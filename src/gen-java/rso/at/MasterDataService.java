...
public class MasterDataService {
  ...
  public interface AsyncIface {
    ...
    public void allocateFile(long fileID, long newFileSize, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.allocateFile_call> resultHandler) throws org.apache.thrift.TException;

    public void createFileTransaction(rso.at.Transaction transaction, long fileID, long offset, long size, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.createFileTransaction_call> resultHandler) throws org.apache.thrift.TException;

    public void applyChanges(long fileID, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.applyChanges_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void allocateFile(long fileID, long newFileSize, org.apache.thrift.async.AsyncMethodCallback<allocateFile_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class allocateFile_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public allocateFile_call(long fileID, long newFileSize, org.apache.thrift.async.AsyncMethodCallback<allocateFile_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public void createFileTransaction(rso.at.Transaction transaction, long fileID, long offset, long size, org.apache.thrift.async.AsyncMethodCallback<createFileTransaction_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class createFileTransaction_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long offset;
      private long size;
      public createFileTransaction_call(rso.at.Transaction transaction, long fileID, long offset, long size, org.apache.thrift.async.AsyncMethodCallback<createFileTransaction_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public void applyChanges(long fileID, org.apache.thrift.async.AsyncMethodCallback<applyChanges_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class applyChanges_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long fileID;
      public applyChanges_call(long fileID, org.apache.thrift.async.AsyncMethodCallback<applyChanges_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.fileID = fileID;
      }
  ...
  public static class allocateFile_args implements org.apache.thrift.TBase<allocateFile_args, allocateFile_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(allocateFile_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetNewFileSize()).compareTo(typedOther.isSetNewFileSize());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetNewFileSize()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newFileSize, typedOther.newFileSize);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
  ...
  public static class createFileTransaction_args implements org.apache.thrift.TBase<createFileTransaction_args, createFileTransaction_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(createFileTransaction_args other) {
      ...
      int lastComparison = 0;
      createFileTransaction_args typedOther = (createFileTransaction_args)other;
  ...
  public static class createFileTransaction_result implements org.apache.thrift.TBase<createFileTransaction_result, createFileTransaction_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(createFileTransaction_result other) {
      ...
      int lastComparison = 0;
      createFileTransaction_result typedOther = (createFileTransaction_result)other;
  ...
  public static class applyChanges_args implements org.apache.thrift.TBase<applyChanges_args, applyChanges_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(applyChanges_args other) {
      ...
      int lastComparison = 0;
      applyChanges_args typedOther = (applyChanges_args)other;
  ...
  public static class applyChanges_result implements org.apache.thrift.TBase<applyChanges_result, applyChanges_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public int compareTo(applyChanges_result other) {
      ...
      int lastComparison = 0;
      applyChanges_result typedOther = (applyChanges_result)other;
